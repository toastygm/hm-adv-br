...
template.url = "https://github.com/toastygm/hm-adv-br";
template.bugs = "https://github.com/toastygm/hm-adv-br/issues";
template.manifest =
    "https://github.com/toastygm/hm-adv-br/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-adv-br/releases/download/v${pkg.version}/module.zip`;
